...
var CAVE = {
    ...
    init : function(){
        ...
        var objs = [
            // [MODEL_NAME, POSITION = [X, Y, Z], SCALE = [X, Y, Z], ROTATION = [theta_deg, phi_deg]] //theta = y, phi = x
	...
	drawSceneOntoTexture : function(displaySurface, fboName){
		...
		GLV.scene.draw(displaySurface.viewingMatrix(this.leftEye), displaySurface.projectionMatrix(this.leftEye, this.near, this.far));
		gl.colorMask(false, true, true, true);
		GLV.scene.draw(displaySurface.viewingMatrix(this.rightEye), displaySurface.projectionMatrix(this.rightEye, this.near, this.far));
		gl.colorMask(true, true, false, true);

		//GLV.scene.draw(GLV.camera.mvMat.copy(), GLV.camera.pMat.copy());   // viewing, projection for the diaply Surf
